  ...
  return (
    <>
      <main>
        ...
        <h1>Button colors</h1>
        <p>The buttons show how we want our developers to style them. The buttons text change color due to :hover and while clicked :active. Here are the suggested color combinations for buttons Please hover over and click on all the button examples.</p>
